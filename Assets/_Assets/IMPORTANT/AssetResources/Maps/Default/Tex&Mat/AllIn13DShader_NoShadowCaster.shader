Shader "AllIn13DShader/AllIn13DShader_NoShadowCaster" {
	Properties {
		...
		[EffectProperty(ParentEffect# SHADINGMODEL, Keywords(_SHADINGMODEL_PBR), AllowReset# True)] [Toggle(_METALLIC_MAP_ON)] _MetallicMapOn ("Use Metallic Map?", Float) = 0
		...
		[EffectProperty(ParentEffect# SHADINGMODEL, Keywords(_SHADINGMODEL_PBR), AllowReset# True)] [Toggle(_GLOSS_MAP_ON)] _GlossMapOn ("Use Gloss Map?", Float) = 0
		...
		[EffectProperty(ParentEffect# AFFECTED_BY_LIGHTMAPS, Keywords(_LIGHTMAP_COLOR_CORRECTION_ON), AllowReset# True)] _ContrastLM ("Contrast", Range(0, 20)) = 1
		[EffectProperty(ParentEffect# AFFECTED_BY_LIGHTMAPS, Keywords(_LIGHTMAP_COLOR_CORRECTION_ON), AllowReset# True)] _BrightnessLM ("Brightness", Range(-2, 2)) = 0
		...
		[EffectProperty(TRIPLANAR_MAPPING)] [NoScaleOffset] _TriplanarTopNormalMap ("Top Normal Map", 2D) = "bump" {}
