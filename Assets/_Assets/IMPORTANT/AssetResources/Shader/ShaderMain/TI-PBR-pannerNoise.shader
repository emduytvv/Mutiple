Shader "TI-Shader/PBR/TI-PBR-pannerNoise" {
	Properties {
		...
		[Header(Panner noise)] _Noisemap ("Noise map", 2D) = "black" {}
		[HDR] _Noisecolor ("Noise color", Vector) = (1,1,1,0)
		_TilingGnoise ("Tiling G noise", Float) = 0.4
		_TilingBnoise ("Tiling B noise", Float) = 0.4
		_SpeedGnoise ("Speed G noise", Vector) = (0,0,0,0)
		_SpeedBnoise ("Speed B noise", Vector) = (0,0,0,0)
