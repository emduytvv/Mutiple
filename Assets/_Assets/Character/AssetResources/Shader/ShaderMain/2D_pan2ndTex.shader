Shader "TW/2D_pan2ndTex" {
	Properties {
		...
		_Tiling2ndTex ("Tiling 2nd Tex", Float) = 0.4
		_2ndTexSpeedV ("2nd Tex - Speed V", Float) = 0
		_2ndTexSpeedU ("2nd Tex - Speed U", Float) = 0
		[Toggle] _Is2ndTexadd ("Is 2ndTex add?", Float) = 0
		_2ndTexDirection ("2nd Tex Direction", Float) = 0
