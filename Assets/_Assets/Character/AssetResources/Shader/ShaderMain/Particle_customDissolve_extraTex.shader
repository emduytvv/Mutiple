Shader "TW/Particle/Particle_customDissolve_extraTex" {
	Properties {
		...
		[HDR] _Bordercolor ("Border color", Vector) = (1,0,0,0)
		_Borderwidth ("Border width", Float) = 0.23
		_Borderfalloff ("Border falloff", Range(0, 1)) = 0.5
		[Toggle] _Isbordercoloradd ("Is border color add?", Float) = 1
